...
public class CellDataTests
{
    ...
    // A cell builds its Data when asked rather than holding one, so two reads of an unchanged cell
    // are two instances. Everything below fails if they compare by reference.
