    ...
    public static async Task Run(int n, int iterations)
    {
        ...
        for (var i = 0; i < iterations; i++)
        {
            ...
            Console.WriteLine(string.Create(CultureInfo.InvariantCulture,
                $"  {i,2}  {allocated / 1024.0,8:0.0}  {precise / 1024.0,11:0.0}  {(precise - allocated) / 1024.0,8:0.0}   {GC.CollectionCount(0) - g0,3}{GC.CollectionCount(1) - g1,3}{GC.CollectionCount(2) - g2,3}"));
        }
