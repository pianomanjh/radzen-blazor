        ...
        new Example
        {
            ...
            Children = new []
            {
                ...
                new Example
                {
                    ...
                    Description = "Write an XLSX file directly from an Entity Framework query. Rows are read once and never built as cells, so the write does not grow with the row count.",
